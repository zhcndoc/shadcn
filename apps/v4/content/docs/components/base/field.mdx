---
title: 字段 Field
description: 结合标签、控件和帮助文本，以组成可访问的表单字段和分组输入。
base: base
component: true
---
...
一组相关字段。必要时在分区之间使用 `FieldSeparator`。
...
请参阅 [Form](/docs/forms) 文档，了解如何使用 `Field` 组件与 [React Hook Form](/docs/forms/react-hook-form)、[Tanstack Form](/docs/forms/tanstack-form) 或 [Formisch](/docs/forms/formisch) 构建表单。
