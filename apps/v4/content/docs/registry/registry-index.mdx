...
你可以通过提交 PR 来向索引中添加注册表，只需将其添加到 [registries.json](https://github.com/shadcn-ui/ui/blob/main/apps/v4/public/r/registries.json) 文件中。
...
在 `shadcn/ui` 项目的根目录，你可以运行以下命令来验证 `registries.json` 文件。
