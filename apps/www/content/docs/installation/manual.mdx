...
[按照 Tailwind CSS 安装说明开始。](https://tailwindcss.com/docs/installation)
...
`@` 别名是一个偏好。如果您愿意，可以使用其他别名。

### 配置样式

在您的 styles/globals.css 文件中添加以下内容。您可以在 [主题部分](/docs/theming) 中了解有关使用 CSS 变量进行主题设置的更多信息。
...
在项目的根目录下创建一个 `components.json` 文件。
